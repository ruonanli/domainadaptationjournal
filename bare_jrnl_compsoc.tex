...
\end{equation} 
This new feature implicitly incorporates the smooth change from one domain to the other, and therefore bridges the two domains and serves as a new, unified feature vector. 
